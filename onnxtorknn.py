...
if __name__ == '__main__':
    ...
    # Pre-process config
    print('--> Config model')
    rknn.config(mean_values=[[0.485, 0.456, 0.406]], std_values=[[0.229, 0.224, 0.255]], target_platform=platform)
    print('done')

    # Load model
    print('--> Loading model')
    ret = rknn.load_onnx(model=model_path, input_size_list=[[1,3,128,128], [1,3,128,128], [1,3,288,288]])
    if ret != 0:
